...
st.set_page_config(
    ...
    menu_items={
        "About": "Лабораторна робота №3 з системного аналізу. Виконали: Шапошнікова Софія (КА-02) та Шушар Антон (КА-01)"
    },
)
...
poly_type = st.radio("Вигляд поліномів", ["Чебишова 2-го порядку", "Чебишова 2-го порядку зміщені", "Власна структурна функція"])
...
x2_deg = cols[1].number_input("для X2", value=2, step=1, key="x2_deg")
x3_deg = cols[2].number_input("для X3", value=8, step=1, key="x3_deg")
